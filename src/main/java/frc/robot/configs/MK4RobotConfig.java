...
public class MK4RobotConfig extends RobotConfig {
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET = 282.74;
  ...
  private static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 339.21;
  ...
  private static final double BACK_LEFT_MODULE_STEER_OFFSET = 219.111;
  ...
  private static final double BACK_RIGHT_MODULE_STEER_OFFSET = 47.021 + 180;

  private static final int GYRO_ID = 18;

  // FIXME: update robot dimensions
  private static final double TRACKWIDTH_METERS = 0.5207;
  private static final double WHEELBASE_METERS = 0.5207;
